...
#		flag = True
#		if _edge_len_[_tri,0] > ds:
#			_tri_sorted_.append( _tri )
#			flag = False
#			
#		if flag and _edge_len_[_tri,1] > ds:
#			_tri_sorted_.append( _tri )
#			flag = False
#			
#		if flag and _edge_len_[_tri,2] > ds:
#			_tri_sorted_.append( _tri )
#			flag = False
#	
#	return _tri_sorted_ 
...
def _sorting_triangles_max_( _edge_len_, ds ):
	...
	for itr in range(_no_tri_):
		...
		if len(POS) == 1:
			...
			print( 'edge_len = ',  _edge_len_[ itr, POS[0] ] )
...
#	for itr in range(_no_tri_):
#		flag = True
#		if _edge_len_[itr,0] >= ds:
#			_tri_sorted_.append(itr)
#			_edge_sorted_.append(0)
#			flag = False
#		
#		if flag and _edge_len_[itr,1] >= ds:
#			_tri_sorted_.append(itr)
#			_edge_sorted_.append(1)
#			flag = False
#		if flag and _edge_len_[itr,2] >= ds:
#			_tri_sorted_.append(itr)
#			_edge_sorted_.append(2)
#			flag = False
#	
...
#	_tri_sorted_ = _sorting_triangles_max_( _edge_len_, ds )
	
	_tri_sorted_, _edge_sorted_ = _sorting_triangles_max_( _edge_len_, ds )
	
#	print('shape_tri  = ', _tri_sorted_.shape)
#	print('shape_edge = ', _edge_sorted_.shape)
	#if len(_edge_sorted_) > 1: _tri_sorted_ = _tri_sorted_.reshape(-1,1)
...
def _min_edge_length_dection_(_triXC, _triYC, _triZC, ds):
	...
	_tri_sorted_ = _sorting_triangles_min_( _edge_len_, ds )
