...
def _add_(_gridVelX_, _gridVelY_, _gridVelZ_, _grid_coord_, coord, _list_, delr, epsx, epsy, epsz):
...
def _D3_Peskin_function_(_gridVelX_, _gridVelY_, _gridVelZ_, coord, _grid_coord_, ds, delr):
	...
	# middle box
	_list_ = _find_elements_nearby_3dgrid_( coord[0], coord[1], coord[2], epsx, epsy, epsz, _grid_coord_ )
	if len(_list_) > 0: 
		sum_x, sum_y, sum_z = _add_(_gridVelX_, _gridVelY_, _gridVelZ_, _grid_coord_, coord, _list_, delr, epsx, epsy, epsz)
...
def _D3_Peskin_function_W_box_(_gridVelX_, _gridVelY_, _gridVelZ_, coord, _grid_coord_, ds, delr):
	...
	_list_ = _find_elements_nearby_3dgrid_( coord[0], coord[1], coord[2], epsx, epsy, epsz, _grid_coord0_ ) 
	if len(_list_) > 0: 
		sum_x, sum_y, sum_z = _add_(_gridVelX_, _gridVelY_, _gridVelZ_, _grid_coord_, coord, _list_, delr, epsx, epsy, epsz)
...
def _D3_Peskin_function_EN_box_(_gridVelX_, _gridVelY_, _gridVelZ_, coord, _grid_coord_, ds, delr):
	...
	_list_ = _find_elements_nearby_3dgrid_( coord[0], coord[1], coord[2], epsz, epsy, epsz, _grid_coord0_ )
	if len(_list_) > 0: 
		sum_x, sum_y, sum_z = _add_(_gridVelX_, _gridVelY_, _gridVelZ_, _grid_coord_, coord, _list_, delr, epsx, epsy, epsz)
