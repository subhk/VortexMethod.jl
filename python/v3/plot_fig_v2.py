...
#ax.plot_trisurf( x1, y1, z1,  triangles=tri,  lw=0.1, edgecolor="black",  antialiased=True, color="lightgrey", alpha=0.4, shade=True )
ax.plot_trisurf( x1, y1, z1,  triangles=tri, lw=None, linestyle='None', antialiased=False,  color="darkgray", alpha=1.0, shade=True )
#ax.plot_trisurf( x1, y1, z1,  triangles=tri,  alpha=.9, linewidth=0, cmap=plt.cm.gist_earth, antialiased=False, shade=False, rstride=1, cstride=1 )
ax.view_init(30, 20)
ax.axis('off')
...
plt.axis([0., 1., 0., 1.])
ax.set_zlim3d(1.5*min_z, 1.5*max_z)
